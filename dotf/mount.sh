...
if [ ! -d /srv/blue/cs115 ]
then
  sshfs lschroth@blue.cs.sonoma.edu:/home/student/lschroth/ /srv/blue -o IdentityFile=/home/liam/.cert/blueppk,reconnect,ServerAliveInterval=15,ServerAliveCountMax=3
  if [ ! -d /srv/blue/cs115 ]
  then
